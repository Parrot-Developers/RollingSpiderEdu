...
/usr/bin/expect -c 'set timeout 10; spawn telnet 192.168.1.1; expect "RS.edu] \$ "; send "cd /data/edu/params; sed \"1s/.*/IP : 192.168.1.2;/\" paramsEDU.dat > paramsEDU.dat.bc; mv paramsEDU.dat.bc paramsEDU.dat; exit\r"; expect eof'
